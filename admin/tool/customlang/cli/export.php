...
-o, --overwrite           Overwrite existing files in the target folder. Note: If the target is not set, the files are always overwritten!
...
\$ sudo -u www-data /usr/bin/php admin/tool/customlang/cli/export.php --lang='en' --components='moodle,quiz' --target='~/customlang'
";
    echo $help;
    die;
}
    ...
    if ($options['components']) {
        ...
        foreach($components as $component) {
            ...
            if(file_exists($filepath)) {
                ...
                cli_problem(get_string('cliexportfilenotfoundforcomponent', 'tool_customlang', ['lang' => $lang, 'file' => $filepath]));
            }
        }
    } else {
