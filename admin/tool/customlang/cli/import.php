...
Options:
--lang                  The target lang (will get from filename if not provided)
...
--chekin                Save strings to the language pack
-h, --help              Print out this help

Examples:
\$sudo -u www-data /usr/bin/php admin/tool/customlang/cli/import.php --lang=en --source=customlangs.zip

\$sudo -u www-data /usr/bin/php admin/tool/customlang/cli/import.php --soucre=\\tmp\\customlangs --checkin

\$sudo -u www-data /usr/bin/php admin/tool/customlang/cli/import.php --lang=en --source=\\tmp\\customlangs
