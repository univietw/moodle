...
$string['clifiles'] = 'Files to import on lang "{$a}"';
$string['cliimporting'] = 'Import files string (mode {$a})';
$string['clinolog'] = 'Nothing to import in lang "{$a}"';
$string['climissinglang'] = 'Missing lang';
$string['climissingfiles'] = 'Missing valid files';
$string['climissingmode'] = 'Missing or invalid mode (valids are all, new or update)';
